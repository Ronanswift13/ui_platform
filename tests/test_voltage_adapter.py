...
class TestVoltageAdapterManager(unittest.TestCase):
    ...
    def test_set_voltage_level_220kv(self):
        ...
        # get_current_level 返回前端显示格式
        self.assertEqual(self.manager.get_current_level(), "HV_220kV")
        # get_current_level_internal 返回内部标准化格式
        self.assertEqual(self.manager.get_current_level_internal(), "220kV")
    ...
    def test_set_voltage_level_500kv(self):
        ...
        self.assertTrue(result)
        # get_current_level 返回前端显示格式
        self.assertEqual(self.manager.get_current_level(), "EHV_500kV")
        # get_current_level_internal 返回内部标准化格式
        self.assertEqual(self.manager.get_current_level_internal(), "500kV_AC")
    ...
    def test_set_voltage_level_1000kv(self):
        ...
        self.assertTrue(result)
        # get_current_level 返回前端显示格式
        self.assertEqual(self.manager.get_current_level(), "UHV_1000kV_AC")
        # get_current_level_internal 返回内部标准化格式
        self.assertEqual(self.manager.get_current_level_internal(), "1000kV_AC")
    ...
    def test_set_voltage_level_35kv(self):
        ...
        self.assertTrue(result)
        # get_current_level 返回前端显示格式
        self.assertEqual(self.manager.get_current_level(), "MV_35kV")
        # get_current_level_internal 返回内部标准化格式
        self.assertEqual(self.manager.get_current_level_internal(), "35kV")
    ...
    def test_set_voltage_level_10kv(self):
        ...
        self.assertTrue(result)
        # get_current_level 返回前端显示格式
        self.assertEqual(self.manager.get_current_level(), "LV_10kV")
        # get_current_level_internal 返回内部标准化格式
        self.assertEqual(self.manager.get_current_level_internal(), "10kV")
    ...
    def test_normalize_voltage_level(self):
        ...
        result = self.manager.set_voltage_level("220kv")
        self.assertTrue(result)
        # 后端格式 220kv 会被标准化为 220kV，然后转换为前端格式 HV_220kV
        self.assertEqual(self.manager.get_current_level(), "HV_220kV")
        self.assertEqual(self.manager.get_current_level_internal(), "220kV")
    ...
    def test_get_voltage_level_info(self):
        ...
        # voltage_level 返回前端格式
        self.assertEqual(info["voltage_level"], "EHV_500kV")
...
class TestHelperFunctions(unittest.TestCase):
    ...
    def test_create_voltage_adapter(self):
        ...
        # 返回前端格式
        self.assertEqual(adapter.get_current_level(), "HV_220kV")
        self.assertEqual(adapter.get_current_level_internal(), "220kV")
...
class TestIntegration(unittest.TestCase):
    ...
    def test_complete_workflow(self):
        ...
        # 返回前端格式
        self.assertEqual(manager.get_current_level(), "HV_220kV")
        self.assertEqual(manager.get_current_level_internal(), "220kV")
    ...
    def test_voltage_level_switching(self):
        ...
        for display_level, internal_level in frontend_levels:
            self.assertTrue(manager.set_voltage_level(display_level), f"无法切换到 {display_level}")
            self.assertEqual(manager.get_current_level(), display_level)
            self.assertEqual(manager.get_current_level_internal(), internal_level)
