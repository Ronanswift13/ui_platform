#!/usr/bin/env python3
"""Switch Inspection - Standalone Tests"""
import sys
import unittest
...
class TestSwitchInspectionStandalone(unittest.TestCase):
    """Test switch inspection plugin in standalone mode."""
    ...
    def test_create_standalone(self):
        ...
        self.assertEqual(self.plugin.id, "switch_inspection")
