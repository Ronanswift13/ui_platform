#!/usr/bin/env python3
"""Action Event Monitoring - Standalone Application."""
...
from plugins.action_event_monitoring.plugin import ActionEventMonitoringPlugin as Plugin
...
def main() -> None:
    ...
    runner.run(host="0.0.0.0", port=8097)
