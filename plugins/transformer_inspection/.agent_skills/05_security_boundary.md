...
`context.metadata["thermal_frame"]` may carry an in-memory thermal array for standalone/test use, but this plugin should not persist that frame to the repository.
