...
All `/implement`, `/repair`, and `/audit` work for `transformer_inspection` must read this file first.
...
4. do not claim replay coverage, field accuracy, or valve-state runtime support that is not present
