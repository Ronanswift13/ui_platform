...
Usage:
    # 从项目根目录运行:
    python -m plugins.transformer_inspection

    # 从插件目录运行:
    cd plugins/transformer_inspection && python -m standalone.app

    # 直接运行:
    python plugins/transformer_inspection/run_standalone.py
"""
import sys
...
from plugins.transformer_inspection.standalone.app import main
