#!/usr/bin/env python3
"""Hyperspectral Detection - Standalone"""
import sys
...
from plugins.hyperspectral_detection.plugin import HyperspectralDetectionPlugin as Plugin
...
def main():
    ...
    runner.run(host="0.0.0.0", port=8095)
