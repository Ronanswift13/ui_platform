...
2. Renaming published labels or alarm severities without explicit need.
3. Rewriting the detector’s traditional CV path.
4. Claiming HF-level replay capability without new fact sources.
