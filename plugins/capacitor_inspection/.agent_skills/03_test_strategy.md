...
- Intrusion positive cases are validated by contract tests, not by replay evidence.
- Traditional CV thresholds still need manual cleanup and config alignment.
