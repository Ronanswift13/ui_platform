...
Usage:
    # 从项目根目录运行:
    python -m plugins.animal_detection

    # 从插件目录运行:
    cd plugins/animal_detection && python -m standalone.app

    # 直接运行:
    python plugins/animal_detection/run_standalone.py
"""
import sys
...
from plugins.animal_detection.standalone.app import main
