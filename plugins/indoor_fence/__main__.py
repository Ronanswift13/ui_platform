...
Usage:
    # 从项目根目录运行:
    python -m plugins.indoor_fence

    # 从插件目录运行:
    cd plugins/indoor_fence && python -m standalone.app

    # 直接运行:
    python plugins/indoor_fence/run_standalone.py
"""
import sys
...
from plugins.indoor_fence.standalone.app import main
