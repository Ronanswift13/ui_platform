...
"$PYTHON_CMD" -m pytest \
  plugins/device_monitoring/tests/test_config_contract.py \
  plugins/device_monitoring/tests/test_process_contract.py \
  plugins/device_monitoring/tests/test_detector.py \
  plugins/device_monitoring/tests/test_device_replay.py \
  plugins/device_monitoring/tests/test_standalone.py
