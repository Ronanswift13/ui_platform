...
class PluginCapability(str, Enum):
    ...
    SPECIES_IDENTIFICATION = "species_identification"  # 种类识别
    RISK_ASSESSMENT = "risk_assessment"  # 风险评估
    DETERRENT_CONTROL = "deterrent_control"  # 驱离控制
    PERSON_DETECTION = "person_detection"  # 人员检测
    MULTI_TARGET_TRACKING = "multi_target_tracking"  # 多目标跟踪
